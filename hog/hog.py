...
def boar_brawl(player_score, opponent_score):
    ...
    if(ten_digit>one_digit):
        return (ten_digit-one_digit)*3
    elif(ten_digit<one_digit):
        return (one_digit-ten_digit)*3
    else:
        return 1
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    for i in range(1, 11):
        current_avg = avg_roll(i, dice)
        if current_avg > score:
            num = i
            score = current_avg
    return num
    # END PROBLEM 9
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    points = boar_brawl(score, opponent_score)
    if points >= threshold:
        return 0
    else:
        return num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    final = sus_update(0,score,opponent_score)
    gain = final - score
    if gain >= threshold:
        return 0
    else:
